#ifndef TRACKER_EIGEN_3_OBS_H_
#define TRACKER_EIGEN_3_OBS_H_
...
struct ProbData
  {
    float maxiter,x_init,vx_init,ax_init,y_init ,vy_init,ay_init,z_init,vz_init,az_init,
        ...
        ,vx_max ,ax_min ,ax_max ,y_min,y_max ,vy_min ,vy_max,ay_min ,ay_max ,z_min ,z_max ,vz_min ,vz_max ,az_min
         ...
         obs_3_vy, x_obs_1_init, x_obs_2_init, x_obs_3_init, y_obs_1_init, y_obs_2_init, y_obs_3_init, alphadot_init, rho_obs, rho_occ, rho_ineq, t_update, t_up;
