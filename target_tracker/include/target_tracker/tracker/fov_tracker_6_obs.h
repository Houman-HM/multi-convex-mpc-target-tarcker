#ifndef DYN_TRACKER_H_6_obs
#define DYN_TRACKER_H_6_obs
...
struct ProbData
  {
    float maxiter,x_init,vx_init,ax_init,y_init ,vy_init,ay_init,z_init,vz_init,az_init,
        ...
        ,vx_max ,ax_min ,ax_max ,y_min,y_max ,vy_min ,vy_max,ay_min ,ay_max ,z_min ,z_max ,vz_min ,vz_max ,az_min
         ,az_max, az_fin,t, v_min, v_max, v_ref, psidot_max, psiddot_max, phi_max, a_max, v_des, v_init, obs_1_vx, obs_2_vx, obs_3_vx, obs_1_vy, obs_2_vy, 
         obs_3_vy, x_obs_1_init, x_obs_2_init, x_obs_3_init, y_obs_1_init, y_obs_2_init, y_obs_3_init, alphadot_init, rho_obs, rho_occ, rho_ineq, t_update, t_up, vx_target,vy_target,
         x_target_init, y_target_init, rho_fov, d_fov_min, d_fov_max, theta_target_init, v_target, omega_target,
         x_obs_4_init, y_obs_4_init, obs_4_vx, obs_4_vy, x_obs_5_init, y_obs_5_init, obs_5_vx, obs_5_vy, x_obs_6_init, y_obs_6_init, obs_6_vx, obs_6_vy,
         x_obs_7_init, y_obs_7_init, obs_7_vx, obs_7_vy;
...
namespace optim
{
  ...
  Eigen::ArrayXXf P, Eigen::ArrayXXf Pdot, Eigen::ArrayXXf Pddot, Eigen::ArrayXXf tot_time,
  Eigen::ArrayXXf u, Eigen::ArrayXXf tot_time_up);
  TwoVarScalar compute_x (ProbData prob_data, ArrayXXf P, ArrayXXf Pdot,ArrayXXf Pddot, float rho_fov, ArrayXXf u);
